...
def SaveToNetCDF4(outfilename, predicted, netCDFData, timeStamp):
    ...
    times.calendar = 'proleptic_gregorian' #netCDFData.variables['time'].attrs['calendar']
    # pdb.set_trace()
...
def testMosaicTiledProductSingleTimePrediction(t, httpLinkOrFile):
    ...
    model = loadMLModel(
        '/lustre/storeB/project/IT/geout/weamyl/weamyl_model/ml_model/version0/ML_usage_codesample/128x128_trained_135ep_20210107.hdf5')
    ...
    outfilename = '/lustre/storeB/project/IT/geout/weamyl/weamyl_model/output/version0/predicted_reflectivity_yrwms-nordic_version0_latest_5min.nc'
